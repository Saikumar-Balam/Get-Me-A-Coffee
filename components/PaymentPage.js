    ...
    return (
        <>
            ...
            <div className="cover w-full bg-red-50 relative">
                <img className='object-cover w-full h-48 md:h-[350]' src={currentUser.coverpic} alt="cover" />
                <div className='absolute -bottom-20 right-[38%] md:right-[46%]  border-white border-2 rounded-full size-36 overflow-hidden'>
                    <img className='rounded-full object-cover size-36' src={currentUser.profilepic} alt="cat" />
                </div>
            </div>

            <div className="info flex flex-col items-center justify-center my-24 gap-2 ">
                ...
                <div className="payment flex gap-3 w-[80%] mt-11 flex-col md:flex-row ">
                    ...
                    <div className="makePayment w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
                        ...
                        <div className="flex flex-col md:flex-row gap-3 mt-5">
                            ...
                            <button className='bg-slate-800  p-3 rounded-lg' onClick={() => pay(1000)} >Pay ₹20</button>
                            <button className='bg-slate-800  p-3 rounded-lg' onClick={() => pay(1000)} >Pay ₹30</button>
                        </div>
                    </div>
                </div>
            </div>
